 ...
 * projects. 
 *
 * It provides a flexible SpriteEllipse class to manage visual objects in 2D space
...
/** 
* A Group containing all the spritesEllipse in the sketch.
*
* @property allSprites
* @type {Group}
*/
...
/**
   * A SpriteEllipse is the main building block of p5.play:
   * an element able to store images or animations with a set of
   * properties such as position and visibility.
   * A SpriteEllipse can have a collider that defines the active area to detect
   * collisions or overlappings with other spritesEllipse and mouse interactions.
   * 
   * @method createSprite
   ...
   *                       collider until an image or new collider are set
   * @return {Object} The new spriteEllipse instance
   */

p5.prototype.createSpriteEllipse = function(x, y, width, height) {
  var s = new SpriteEllipse(x, y, width, height);
...
/**
   * Removes a SpriteEllipse from the sketch. 
   * The removed SpriteEllipse won't be drawn or updated anymore.
   * Equivalent to SpriteEllipse.remove()
   *
   * @method removeSprite
   * @param {Object} spriteEllipse SpriteEllipse to be removed
*/
p5.prototype.removeSpriteEllipse = function(spriteEllipse) {
  spriteEllipse.remove();
}

/** 
* Updates all the spritesEllipse in the sketch (position, animation...)
* it's called automatically at every draw().
* It can be paused by passing a parameter true or false;
* Note: it does not render the spritesEllipse.
*
...
/** 
* Returns all the spritesEllipse in the sketch as an array
*
* @method getSprites
* @return {Array} Array of SpritesEllipse
*/
...
/** 
* Displays a Group of spritesEllipse.
* If no parameter is specified, draws all spritesEllipse in the
* sketch.
* The drawing order is determined by the SpriteEllipse property "depth"
*
* @methid drawSprites
* @param {Group} [group] Group of SpritesEllipse to be displayed
*/
p5.prototype.drawSprites = function(group) {
  ...
  else if(arguments.length===1)
  {
    if(arguments[0] instanceof Array == false)
      throw("Error: with drawSprites you can only draw all spritesEllipse or a group");
    else
    {
      arguments[0].draw();
    }
...
/** 
* Displays a SpriteEllipse.
* To be typically used in the main draw function.
* 
* @method drawSprite
* @param {SpriteEllipse} spriteEllipse SpriteEllipse to be displayed
*/
p5.prototype.drawSprite = function(spriteEllipse) {
  spriteEllipse.display();
}
...
* It can improve performance when there is a large number of SpritesEllipse to be
...
function SpriteEllipse(_x, _y, _w, _h) {

  /**
  * The spriteEllipse's position of the spriteEllipse as a vector (x,y).
  * @property position
  * @type {p5.Vector}
  */
  ...
  /**
  * The spriteEllipse's position at the beginning of the last update as a vector (x,y).
  ...
  */
  ...
  /*
  The spriteEllipse's position at the end of the last update as a vector (x,y).
  ...
  */
  ...
  /**
  * The spriteEllipse's velocity as a vector (x,y)
  ...
  */
  ...
  /**
  * Set a limit to the spriteEllipse's scalar speed regardless of the direction.
  ...
  */
  ...
  /**
  * Friction factor, reduces the spriteEllipse's velocity.
  ...
  */
  ...
  /**
  * The spriteEllipse's current collider.
  * It can either be an Axis Aligned Bounding Box (a non-rotated rectangle)
  * or a circular collider.
  * If the spriteEllipse is checked for collision, bounce, overlapping or mouse events the
  * collider is automatically created from the width and height parameter passed at the
  * creation of the spriteEllipse or the from the image dimension in case of animate spritesEllipse
  *
  * You can set a custom collider with SpriteEllipse.setCollider
  *
  * @property collider
  * @type {Object}
  */
  ...
  * To be typically used in combination with SpriteEllipse.overlap or SpriteEllipse.collide
  * functions.
  ...
  */
  ...
  /**
  * The mass determines the velocity transfer when spritesEllipse bounce
  * against each other. See SpriteEllipse.bounce
  * The higher the mass the least the spriteEllipse will be affected by collisions.
  *
  * @property mass
  * @type {Number}
  * @default 1
  */
  ...
  /**
  * If set to true the spriteEllipse won't bounce or be displaced by collisions
  ...
  * (image or animation) to the spriteEllipse's movement direction.
  *
  ...
  */
  ...
  /**
  * Determines the rendering order within a group: a spriteEllipse with 
  ...
  */
  ...
  /**
  * Determines the spriteEllipse's scale.
  ...
  */
  ...
  /**
  * The spriteEllipse's visibility.
  *
  * @property visible
  * @type {Boolean}
  * @default true
  */
  ...
  /**
  * If set to true spriteEllipse will track its mouse state.
  ...
  */
  ...
  /**
  * True if mouse is on the spriteEllipse's collider.
  * Read only.
  *
  ...
  */
  ...
  /**
  * True if mouse is pressed on the spriteEllipse's collider.
  * Read only.
  *
  ...
  */
  ...
  /**
  * Width of the spriteEllipse's current image.
  ...
  */
  ...
  /**
  * Height of the spriteEllipse's current image.
  ...
  */
  ...
  /**
  * Unscaled width of the spriteEllipse
  * If no images or animations are set it's the width of the 
  * placeholder rectangle.
  *
  ...
  */
  ...
  /**
  * Unscaled height of the spriteEllipse
  * If no images or animations are set it's the height of the 
  * placeholder rectangle.
  *
  ...
  */
  ...
  /**
  * False if the spriteEllipse has been removed.
  *
  * @property removed
  * @type {Boolean}
  */
  ...
  * reduced by 1 unit. At 0 it will call a spriteEllipse.remove()
  ...
  */
  ...
  /**
  * Groups the spriteEllipse belongs to, including allSprites
  *
  * @property groups
  * @type {Array}
  */
  ...
  */
  this.update = function() {
    ...
    if(!this.removed)
    {
      ...
      //when I check this spriteEllipse for collisions or overlaps
  ...
  */
  ...
  /**
  * Updates the spriteEllipse mouse states and triggers the mouse events:
  ...
  */
  ...
  /**
  * Sets a collider for the spriteEllipse.
  * 
  * In p5.play a Collider is an invisible circle or rectangle
  * that can have any size or position relative to the spriteEllipse and which
  * will be used to detect collisions and overlapping with other spritesEllipse,
  * or the mouse cursor.
  *
  * If the spriteEllipse is checked for collision, bounce, overlapping or mouse events a
  * collider is automatically created from the width and height parameter passed at the
  * creation of the spriteEllipse or the from the image dimension in case of animate spritesEllipse.
  *
  * Often the image bounding box is not appropriate as active area for
  * a collision detection so you can set a circular or rectangular spriteEllipse with different
  * dimensions and offset from the spriteEllipse's center.
  * 
  * setCollider
  * @method setCollider
  * @param {String} type Either "rectangle" or "circle"
  * @param {Number} offsetX Collider x position from the center of the spriteEllipse
  * @param {Number} offsetY Collider y position from the center of the spriteEllipse
  ...
  */
  ...
  /**
  * Sets the spriteEllipse's horizontal mirroring.
  ...
  */
  ...
  /**
  * Sets the spriteEllipse's vertical mirroring.
  * If 1 the images displayed normally
  ...
  */
  ...
  /**
  * Manages the positioning, scale and rotation of the spriteEllipse
  ...
  */
  ...
  /**
  * Manages the visuals of the spriteEllipse.
  * It can be overridden with a custom drawing function. 
  * The 0,0 point will be the center of the spriteEllipse.
  * Example:
  * spriteEllipse.draw = function() { ellipse(0,0,10,10) }
  * Will display the spriteEllipse as circle.
  *
  * @method draw
  */
  this.draw = function()
  ...
  /**
   * Removes the SpriteEllipse from the sketch. 
   * The removed SpriteEllipse won't be drawn or updated anymore.
   *
   * @method remove
   */
  ...
  */
  ...
  /**
  * Adds the spriteEllipse to an existing group
  *
  * @method addToGroup
  * @param {Object} group
  */
  ...
  */  
  ...
  /**
  * Set the speed and direction of the spriteEllipse.
  ...
  */
  ...
  /**
  * Pushes the spriteEllipse in a direction defined by an angle.
  ...
  */
  ...
  /**
  * Pushes the spriteEllipse toward a point.
  * The force is added to the current velocity. 
  *
  ...
  */
  ...
  /**
  * Adds an image to the spriteEllipse.
  ...
  * The image is stored in the spriteEllipse but not necessarily displayed
  * until SpriteEllipse.changeAnimation(label) is called
  * 
  * Usages:
  * - spriteEllipse.addImage(label, image);
  * - spriteEllipse.addImage(image);
  *
  ...
  */
  ...
  /**
  * Adds an animation to the spriteEllipse.
  * The animation should be preloaded in the preload() function 
  * using loadAnimation.
  * Animations require a identifying label (string) to change them.
  * Animations are stored in the spriteEllipse but not necessarily displayed
  * until SpriteEllipse.changeAnimation(label) is called.
  * 
  * Usage:
  * - spriteEllipse.addAnimation(label, animation);
  *
  * Alternative usages. See Animation for more information on file sequences:
  * - spriteEllipse.addAnimation(label, firstFrame, lastFrame);
  * - spriteEllipse.addAnimation(label, frame1, frame2, frame3...);
  *
  * @method addAnimation
  ...
  */
  this.addAnimation = function(label, animation)
  {
    ...
    {
      print("SpriteEllipse.addAnimation error: the first argument must be a label (String)");
      return -1;
    }
  ...
  * in the spriteEllipse's current image. It can be used to check a point collision 
  * against only the visible part of the spriteEllipse.
  *
  * @method overlapPixel
  ...
  */
  this.overlapPixel = function(pointX, pointY) {
    ...
    {
      print("Error: overlapPixel doesn't work with scaled or rotated spritesEllipse yet");
  ...
  /**
  * Checks if the given point is inside the spriteEllipse's collider.
  *
  * @method overlapPoint
  * @param {Number} pointX x coordinate of the point to check
  * @param {Number} pointY y coordinate of the point to check
  ...
  */
  ...
  /**
  * Checks if the the spriteEllipse is overlapping another spriteEllipse or a group.
  ...
  * spriteEllipse overlapping. The parameter of the function are respectively the
  * current spriteEllipse and the colliding spriteEllipse.
  *
  * @example
  * <code>
  * spriteEllipse.overlap(otherSprite, explosion);
  *
  ...
  *
  * @method overlap
  * @param {Object} target SpriteEllipse or group to check against the current one
  ...
  */
  ...
  /**
  * Checks if the the spriteEllipse is overlapping another spriteEllipse or a group.
  * If the overlap is positive the current spriteEllipse will be displace by
  ...
  * If the target is a group the function will be called for each single 
  * spriteEllipse colliding. The parameter of the function are respectively the
  * current spriteEllipse and the colliding spriteEllipse.
  *
  * @example
  * <code>
  * spriteEllipse.collide(otherSprite, explosion);
  *
  * function explosion(spriteA, spriteB) {
  * spriteA.remove();
  * spriteB.score++;
  ...
  */
  ...
  /**
  * Checks if the the spriteEllipse is overlapping another spriteEllipse or a group.
  * If the overlap is positive the current spriteEllipse will displace
  ...
  * @example
  * <code>
  * spriteEllipse.displace(otherSprite, explosion);
  *
  * function explosion(spriteA, spriteB) {
  * spriteA.remove();
  * spriteB.score++;
  ...
  */
  ...
  /**
  * Checks if the the spriteEllipse is overlapping another spriteEllipse or a group.
  * If the overlap is positive the spritesEllipse will bounce affecting each
  ...
  * @example
  * <code>
  * spriteEllipse.bounce(otherSprite, explosion);
  *
  * function explosion(spriteA, spriteB) {
  * spriteA.remove();
  * spriteB.score++;
  ...
  */
  this.AABBops = function(type, target, callback) {
    ...
    //if single spriteEllipse turn into array anyway
    var others = [];
    
    if(target instanceof SpriteEllipse)
      others.push(target);
    else if(target instanceof Array)
    {
      ...
      throw("Error: overlap can only be checked between spritesEllipse or groups");
...
function Camera(x, y, zoom) {
  ...
  * Offsetting and scaling the canvas will not change the spritesEllipse' position 
...
/**
   * In p5.play groups are collections of spritesEllipse with similar behavior.
   * For example a group may contain all the spritesEllipse in the background 
   * or all the spritesEllipse that "kill" the player.
   *
   * Groups are "extended" arrays and inherit all their properties 
   * e.g. group.length
   * 
   * Since groups contain only references, a spriteEllipse can be in multiple 
   * groups and deleting a group doesn't affect the spritesEllipse themselves. 
   *
   * SpriteEllipse.remove() will also remove the spriteEllipse from all the groups 
   * it belongs to.
   * 
   * @class Group
   * @constructor
...
function Group() {
  ...
  */
  ...
  /**
  * Checks if the group contains a spriteEllipse.
  *
  * @method contains
  * @param {SpriteEllipse} spriteEllipse The spriteEllipse to search
  * @return {Number} Index or -1 if not found
  */
  array.contains = function(spriteEllipse) {
    return this.indexOf(spriteEllipse)>-1;
  };
  ...
  */
  ...
  /**
  * Adds a spriteEllipse to the group.
  *
  * @method add
  * @param {SpriteEllipse} spriteEllipse The spriteEllipse to be added
  */
  array.add = function(s) {

    if(s instanceof SpriteEllipse == false)
      throw("Error: you can only add spritesEllipse to a group");
    else
    {
      array.push(s); // for add(Object)
      s.groups.push(this);
      //next to do add a reference to the group in the spriteEllipse
  ...
  */
  ...
  /**
  * Removes all the spritesEllipse in the group
  * from the scene.
  *
  * @method clear
  */
  ...
  * Does not remove the actual spritesEllipse.
  *
  * @method clear
  */
  ...
  /**
  * Removes a spriteEllipse from the group.
  * Does not remove the actual spriteEllipse, only the affiliation (reference).
  *
  * @method remove
  * @param {SpriteEllipse} spriteEllipse The spriteEllipse to be removed
  * @return {Boolean} True if spriteEllipse was found and removed
  */
  array.remove = function(item) {

    if(item instanceof SpriteEllipse == false)
      throw("Error: you can only remove spritesEllipse from a group");    
  ...
  *
  * @method maxDepth
  * @return {Number} The depth of the spriteEllipse drawn on the top
  */
  ...
  *
  * @method minDepth
  * @return {Number} The depth of the spriteEllipse drawn on the bottom
  */
  ...
  /**
  * Draws all the spritesEllipse in the group.
  *
  * @method draw
  */
  array.draw = function() {
  ...
  * A callback function can be specified to perform additional operations
  * when the overlap occours.
  * The function will be called for each single spriteEllipse overlapping. 
  ...
  */
  ...
  /**
  * Checks if the the group is overlapping another group.
  * If the overlap is positive the spritesEllipse in the group will be displaced 
  ...
  */
  ...
  /**
  * Checks if the the group is overlapping another group.
  * If the overlap is positive the spritesEllipse in the group will displace 
...
function AABB(_center, _extents, _offset) {
  ...
  this.draw = function(col)
  {
    ...
    stroke(0,255,0);
    rectMode(CENTER);
    ellipse(this.center.x+this.offset.x, this.center.y+this.offset.y, this.size().x/2, this.size().y/2);
  }
...
/**
   ...
   *
   * A spriteEllipse can have multiple labeled animations, see SpriteEllipse.addAnimation
   * and SpriteEllipse.changeAnimation, however an animation can be used independently.
   * 
...
function Animation() {
  ...
  */
  ...
  /**
  * Objects are passed by reference so to have different spritesEllipse
  ...
  */
  this.draw = function (x, y) {
    ...
    if (this.visible)
    {
      ...
      //only connection with the spriteEllipse class
...
//automatic spriteEllipse update
